...
export class InternationalizationManager {
    ...
    async initializeTranslations() {
        ...
        if (!this.translations.has('zh')) {
            ...
            "faq.a1": "Wplace 像素艺术转换器是一个免费的在线像素艺术生成器，可将任何图像转换为美丽的像素艺术。我们的 Wplace Paint Tool 使用先进的颜色映射来创造惊艳的效果。",
            ...
            "faq.q4": "有尺寸限制吗？",
            "faq.a4": "没有！与其他工具不同，Wplace 像素艺术转换器没有图像尺寸限制。使用我们强大的 Wplace Paint Tool 处理任何尺寸的图像。",
            ...
            "zoom.out": "缩小",
            "zoom.reset": "重置缩放",
            "stats.imagesConverted": "使用我们的 Wplace Paint Tool 转换的图片",
            "stats.activeUsers": "Wplace Paint Tool 的活跃用户",
            "stats.satisfactionRate": "Wplace Paint Tool 的满意度",
            "footer.aboutTitle": "关于 Wplace Paint Tool",
            "footer.nav.home": "首页",
            "footer.nav.converter": "Wplace 颜色转换器",
            "about.title": "关于 Wplace Paint Tool | 我们的故事与使命",
            "about.heroSubtitle": "Wplace 玩家创建精美像素艺术的终极伴侣。将任何图像转换为 Wplace 兼容的像素网格，并完美匹配颜色。",
            "about.storyTitle": "我们的故事",
            "about.storyPara1": "Wplace Paint Tool 的诞生源于 Wplace 社区成员的奉献精神，他们渴望在游戏中创作出更复杂、更精确的像素艺术。我们观察到玩家在将自己喜欢的图像适应受限的 Wplace 调色板同时保持视觉完整性方面经常面临挑战。",
            ...
            "blog.title": "博客 | Wplace Paint Tool - 学习像素艺术技巧",
            ...
            "blog.readMore": "阅读更多",
            "blog.article1.title": "入门：Wplace Paint Tool 的必备指南",
            ...
            "converter.title": "图像到像素艺术转换器 | Wplace Paint Tool",
            ...
            "converter.features.title": "为什么选择 Wplace Paint Tool？",
        ...
        if (!this.translations.has('en')) {
            ...
            "stats.imagesConverted": "Images converted with our Wplace Paint Tool",
            "stats.activeUsers": "Active users of the Wplace Paint Tool",
            "stats.satisfactionRate": "Satisfaction rate with our Wplace Paint Tool",
